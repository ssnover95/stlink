...
static const struct stlink_chipid_params devices[] = {
    {
        ...
        .chip_id = STLinkSTM32ChipId::F7XXXX,
        .description = "F76xxx device",
        .flash_type = STLinkFlashType::F4,
    ...
    },
    {
        ...
        .chip_id = STLinkSTM32ChipId::F72XXX,
    ...
    {// table 2, PM0063
     .chip_id = STLinkSTM32ChipId::F1_MEDIUM,
     .description = "F1 Medium-density device",
     .flash_type = STLinkFlashType::F0,
    ...
    {// table 1, PM0059
     ...
     .bootrom_size = 0x7800},
    {// PM0063
     .chip_id = STLinkSTM32ChipId::F1_LOW,
    ...
    {.chip_id = STLinkSTM32ChipId::F4,
     ...
     .bootrom_base = 0x1fff0000,
     .bootrom_size = 0x7800},
    {.chip_id = STLinkSTM32ChipId::F4_DSI,
     ...
     .bootrom_base = 0x1fff0000,
     .bootrom_size = 0x7800},
    {.chip_id = STLinkSTM32ChipId::F4_HD,
     ...
     .bootrom_base = 0x1fff0000,
     .bootrom_size = 0x7800},
    {.chip_id = STLinkSTM32ChipId::F4_LP,
     ...
     .bootrom_base = 0x1fff0000,
     .bootrom_size = 0x7800},
    {.chip_id = STLinkSTM32ChipId::F411RE,
     ...
     .bootrom_base = 0x1fff0000,
     .bootrom_size = 0x7800},
    {.chip_id = STLinkSTM32ChipId::F4_DE,
     ...
     .bootrom_base = 0x1fff0000,
     .bootrom_size = 0x7800},
    {.chip_id = STLinkSTM32ChipId::F1_HIGH,
    ...
    {// This ignores the EEPROM! (and uses the page erase size,
     ...
     .chip_id = STLinkSTM32ChipId::L1_MEDIUM,
     .description = "L1 Med-density device",
     .flash_type = STLinkFlashType::L0,
     .flash_size_reg = 0x1ff8004c,
     .flash_pagesize = 0x100,
     .sram_size = 0x4000,
     .bootrom_base = 0x1ff00000,
     .bootrom_size = 0x1000},
    {.chip_id = STLinkSTM32ChipId::L1_CAT2,
     ...
     .bootrom_base = 0x1ff00000,
     .bootrom_size = 0x1000},
    {.chip_id = STLinkSTM32ChipId::L1_MEDIUM_PLUS,
     ...
     .bootrom_base = 0x1ff00000,
     .bootrom_size = 0x1000},
    {.chip_id = STLinkSTM32ChipId::L1_HIGH,
     ...
     .bootrom_base = 0x1ff00000,
     .bootrom_size = 0x1000},
    {.chip_id = STLinkSTM32ChipId::L152_RE,
     .description = "L152RE",
     .flash_type = STLinkFlashType::L0,
     .flash_size_reg = 0x1ff800cc,
     .flash_pagesize = 0x100,
     ...
     .bootrom_base = 0x1ff00000,
     .bootrom_size = 0x1000},
    {.chip_id = STLinkSTM32ChipId::F1_CONN,
    ...
    {// Low and Medium density VL have same chipid. RM0041 25.6.1
     .chip_id = STLinkSTM32ChipId::F1_VL_MEDIUM_LOW,
    ...
    {// STM32F446x family. Support based on DM00135183.pdf (RM0390) document.
     .chip_id = STLinkSTM32ChipId::F446,
    ...
    {// STM32F410 MCUs. Support based on DM00180366.pdf (RM0401) document.
     .chip_id = STLinkSTM32ChipId::F410,
    ...
    {// This is STK32F373VCT6 device from STM32 F373 eval board
     ...
     .chip_id = STLinkSTM32ChipId::F37x,
     .description = "F3 device",
     .flash_type = STLinkFlashType::F0,
     .flash_size_reg = 0x1ffff7cc,
     .flash_pagesize = 0x800,
     ...
     .bootrom_base = 0x1ffff000,
     .bootrom_size = 0x800},
    {.chip_id = STLinkSTM32ChipId::F1_VL_HIGH,
     ...
     .bootrom_base = 0x1ffff000,
     .bootrom_size = 0x800},
    {.chip_id = STLinkSTM32ChipId::F1_XL,
     .description = "F1 XL-density device",
     .flash_type = STLinkFlashType::F1_XL,
     .flash_size_reg = 0x1ffff7e0,
     .flash_pagesize = 0x800,
     .sram_size = 0x18000,
     ...
     .bootrom_size = 0x1800},
    {
        ...
        .chip_id = STLinkSTM32ChipId::F0_CAN,
    ...
    },
    {
        ...
        // Table 4.
        .chip_id = STLinkSTM32ChipId::F412,
        .description = "F4 device",
        .flash_type = STLinkFlashType::F4,
    ...
    },
    {
        ...
        .chip_id = STLinkSTM32ChipId::F413,
        .description = "F4 device",
        .flash_type = STLinkFlashType::F4,
    ...
    {
        .chip_id = STLinkSTM32ChipId::F09X,
    ...
    },
    {
        // Use this as an example for mapping future chips:
        // RM0091 document was used to find these paramaters
        .chip_id = STLinkSTM32ChipId::F0_SMALL,
    ...
    {// STM32F30x
     .chip_id = STLinkSTM32ChipId::F3_SMALL,
    ...
    {// STM32L0x Category 5
     // RM0367,RM0377 documents was used to find these parameters
     .chip_id = STLinkSTM32ChipId::L0_CAT5,
    ...
    {// STM32L0x Category 2
     // RM0367,RM0377 documents was used to find these parameters
     .chip_id = STLinkSTM32ChipId::L0_CAT2,
    ...
    {// STM32F334, STM32F303x6/8, and STM32F328
     ...
     .chip_id = STLinkSTM32ChipId::F334,
    ...
    {// This is STK32F303RET6 device from STM32 F3 Nucelo board.
     ...
     .chip_id = STLinkSTM32ChipId::F303_HIGH,
     ...
     .bootrom_size = 0x2000},
    {
        // STM32L4x6
        // From RM0351.
        .chip_id = STLinkSTM32ChipId::L4,
        .description = "L4 device",
        .flash_type = STLinkFlashType::L4,
        .flash_size_reg = 0x1FFF75e0, // "Flash size data register" (sec 45.2, page 1671)
        .flash_pagesize =
            0x800, // 2K (sec 3.2, page 78; also appears in sec 3.3.1 and tables 4-6 on pages 79-81)
    ...
    },
    {
        // STM32L4RX
        // From DM00310109.pdf
        .chip_id = STLinkSTM32ChipId::L4RX,
    ...
    {
        // STLinkSTM32ChipId::L41X
        // From RM0394 Rev 4 and DS12469 Rev 5
        .chip_id = STLinkSTM32ChipId::L41X,
    ...
    {
        // STLinkSTM32ChipId::L43X
        // From RM0392.
        .chip_id = STLinkSTM32ChipId::L43X,
        .description = "L43x/L44x device",
        .flash_type = STLinkFlashType::L4,
        .flash_size_reg = 0x1fff75e0, // "Flash size data register" (sec 43.2, page 1410)
        .flash_pagesize =
            0x800, // 2K (sec 3.2, page 74; also appears in sec 3.3.1 and tables 7-8 on pages 75-76)
    ...
    {
        // STLinkSTM32ChipId::L46X
        // From RM0394 (updated version of RM0392?).
        .chip_id = STLinkSTM32ChipId::L46X,
    ...
    {// STM32L011
     .chip_id = STLinkSTM32ChipId::L011,
     ...
     .bootrom_size = 0x2000},
    {
        ...
        .chip_id = STLinkSTM32ChipId::G0X1,
        .description = "G071/G081 device",
        .flash_type = STLinkFlashType::G0,
    ...
    {// STM32WB55 (from RM0434)
     .chip_id = STLinkSTM32ChipId::WB55,
     .description = "WB55 device",
     .flash_type = STLinkFlashType::WB,
     ...
     .bootrom_size = 0x7000},
    {// unknown
     .chip_id = STLinkSTM32ChipId::UNKNOWN,
     .description = "unknown device",
     .flash_type = STLinkFlashType::UNKNOWN,
     .flash_size_reg = 0x0,
     .flash_pagesize = 0x0,
     .sram_size = 0x0,
     .bootrom_base = 0x0,
